 ...
 *
 * @package Witlee Template
 * @version 1.0.3
 * @since 	1.0.0
 */
class Witlee_Template_Plugin {
    /**
     ...
     *
     * @return   Witlee Template    A reference to an instance of this class.
     * @since    1.0.0
     */
    public static function get_instance() {
        if( null == self::$instance ) {
            self::$instance = new Witlee_Template_Plugin();
        } // end if
    ...
    private function __construct() {
        ...
        $this->plugin_locale = 'witlee-for-wp';
        ...
        $this->templates = array(
            'store-page.php'     => __( 'Witlee Store', $this->plugin_slug )
    ...
    public function view_project_template( $template ) {
        ...
        $file = plugin_dir_path( __FILE__ ) . 'partials/' . get_post_meta( $post->ID, '_wp_page_template', true );
